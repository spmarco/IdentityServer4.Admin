...
namespace Skoruba.IdentityServer4.Admin.UnitTests.Mocks
{
    ...
    {
        public static Faker<UserIdentityUserLogin> GetUserProvidersFaker(string key, string loginProvider, Guid userId)
        {
        ...
        public static UserIdentityUserLogin GenerateRandomUserProviders(string key, string loginProvider, Guid userId)
        {
